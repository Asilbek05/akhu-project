...
>
        ...
        <i class="ki-outline ki-cross fs-2 fs-lg-1 me-0"></i>    </span>
                        ...
                        <div data-kt-search-element="wrapper">
                            ...
                            <div data-kt-search-element="results" class="d-none">
                                ...
                                <div class="scroll-y mh-200px mh-lg-350px">
                                    ...
                                    <!--begin::Item-->
                                    <a href="index.html#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="https://preview.keenthemes.com/metronic8/demo39/assets/media/avatars/300-6.jpg" alt=""/>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="index.html#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="https://preview.keenthemes.com/metronic8/demo39/assets/media/avatars/300-14.jpg" alt=""/>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="index.html#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="https://preview.keenthemes.com/metronic8/demo39/assets/media/avatars/300-11.jpg" alt=""/>
                                        </div>
                                        <!--end::Symbol-->
                    ...
                    <span class="symbol-label bg-light">
                        <i class="ki-outline ki-laptop fs-2 text-primary"></i>
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">BoomApp by Keenthemes</a>
                    ...
                    <span class="symbol-label bg-light">
                        <i class="ki-outline ki-chart-simple fs-2 text-primary"></i>
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"Kept API Project Meeting</a>
                    ...
                    <span class="symbol-label bg-light">
                        <i class="ki-outline ki-chart fs-2 text-primary"></i>
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"KPI Monitoring App Launch</a>
                    ...
                    <span class="symbol-label bg-light">
                        <i class="ki-outline ki-chart-line-down fs-2 text-primary"></i>
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">Project Reference FAQ</a>
                    ...
                    <span class="symbol-label bg-light">
                        <i class="ki-outline ki-sms fs-2 text-primary"></i>
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"FitPro App Development</a>
                                        <span class="fs-7 text-muted fw-semibold">#84250</span>
                                    </div>
                                    <!--end::Title-->
                                </div>
                    ...
                    <span class="symbol-label bg-light">
                        <i class="ki-outline ki-bank fs-2 text-primary"></i>
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">Shopix Mobile App</a>
                    ...
                    <span class="symbol-label bg-light">
                        <i class="ki-outline ki-chart-line-down fs-2 text-primary"></i>
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"Landing UI Design" Launch</a>
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
                ...
                <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('assets/media/misc/menu-header-bg.jpg')">
                    ...
                    <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                        <li class="nav-item">
                            <a class="nav-link text-white opacity-75 opacity-state-100 pb-4" data-bs-toggle="tab" href="index.html#kt_topbar_notifications_1">Alerts</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active" data-bs-toggle="tab" href="index.html#kt_topbar_notifications_2">Updates</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link text-white opacity-75 opacity-state-100 pb-4" data-bs-toggle="tab" href="index.html#kt_topbar_notifications_3">Logs</a>
                        </li>
                    </ul>
                    <!--end::Tabs-->
                </div>
                        ...
                        <div class="scroll-y mh-325px my-5 px-8">
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <span class="symbol-label bg-light-primary">
                                    ...
                                    <!--begin::Title-->
                                    <div class="mb-0 me-2">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Project Alice</a>
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <span class="symbol-label bg-light-danger">
                                    ...
                                    <!--begin::Title-->
                                    <div class="mb-0 me-2">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">HR Confidential</a>
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <span class="symbol-label bg-light-warning">
                                    ...
                                    <!--begin::Title-->
                                    <div class="mb-0 me-2">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Company HR</a>
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <span class="symbol-label bg-light-success">
                                    ...
                                    <!--begin::Title-->
                                    <div class="mb-0 me-2">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Project Redux</a>
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <span class="symbol-label bg-light-primary">
                                    ...
                                    <!--begin::Title-->
                                    <div class="mb-0 me-2">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Project Breafing</a>
 ...
 fs-2 text-info"></i>
                                    ...
                                    <!--begin::Title-->
                                    <div class="mb-0 me-2">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Banner Assets</a>
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <span class="symbol-label bg-light-warning">
                                    ...
                                    <!--begin::Title-->
                                    <div class="mb-0 me-2">
                                        <a href="index.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Icon Assets</a>
                        ...
                        <div class="d-flex flex-column px-9">
                            ...
                            <div class="pt-10 pb-0">
                                ...
                                <div class="text-center mt-5 mb-9">
                                    <a href="index.html#" class="btn btn-sm btn-primary px-6"  data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan" >Upgrade</a>
                                </div>
                                <!--end::Action-->
                            </div>
                            <!--end::Section-->
                        ...
                        <div class="scroll-y mh-325px my-5 px-8">
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <!--begin::Title-->
                                    <a href="index.html#" class="text-gray-800 text-hover-primary fw-semibold">New order</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Section-->
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <!--begin::Title-->
                                    <a href="index.html#" class="text-gray-800 text-hover-primary fw-semibold">New customer</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Section-->
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <!--begin::Title-->
                                    <a href="index.html#" class="text-gray-800 text-hover-primary fw-semibold">Payment process</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Section-->
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <!--begin::Title-->
                                    <a href="index.html#" class="text-gray-800 text-hover-primary fw-semibold">Search query</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Section-->
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <!--begin::Title-->
                                    <a href="index.html#" class="text-gray-800 text-hover-primary fw-semibold">API connection</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Section-->
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <!--begin::Title-->
                                    <a href="index.html#" class="text-gray-800 text-hover-primary fw-semibold">Database restore</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Section-->
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <!--begin::Title-->
                                    <a href="index.html#" class="text-gray-800 text-hover-primary fw-semibold">System update</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Section-->
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <!--begin::Title-->
                                    <a href="index.html#" class="text-gray-800 text-hover-primary fw-semibold">Server OS update</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Section-->
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <!--begin::Title-->
                                    <a href="index.html#" class="text-gray-800 text-hover-primary fw-semibold">API rollback</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Section-->
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <!--begin::Title-->
                                    <a href="index.html#" class="text-gray-800 text-hover-primary fw-semibold">Refund process</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Section-->
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <!--begin::Title-->
                                    <a href="index.html#" class="text-gray-800 text-hover-primary fw-semibold">Withdrawal process</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Section-->
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <!--begin::Title-->
                                    <a href="index.html#" class="text-gray-800 text-hover-primary fw-semibold">Mail tasks</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Section-->
