        ...
        <section class="contact_section section_space">
            <div class="container">
                    ...
                    <div class="col-lg-7 mb-4 mb-lg-0">
                        <div class="contact_form p-4 shadow-sm rounded h-100">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <?= $form->field($model, 'email')->textInput(['placeholder' => 'example@mail.com', 'class' => 'form-control', 'id' => 'input_email'])->label('Your Email', ['class' => 'input_title']) ?>
                                </div>
                                <div class="col-md-12">
                ...
                <div class="contact_info_box_inner text-center mt-5">
                    ...
                    <p>Please enter the tracking code sent to your email.</p>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card p-4 shadow-sm rounded">
                            <div class="input-group">
                                <input type="text" class="form-control" id="tracking-code-input" placeholder="Enter tracking code..." aria-label="Tracking code">
                                <button class="btn btn-primary" type="button" id="check-status-btn">Check Status</button>
                            </div>
                        </div>
                    </div>
                </div>

                <div class="contact_info_box row mt-5">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="statusModalLabel">So'rov holati</h5>
...
$this->registerJs("
    $('#check-status-btn').on('click', function() {
        var code = $('#tracking-code-input').val();
        if (code) {
            $.ajax({
                url: '{$checkStatusUrl}',
                type: 'POST',
                ...
                beforeSend: function() {
                    $('#statusModal .modal-body').html('<div class=\"text-center\"><div class=\"spinner-border text-primary\" role=\"status\"><span class=\"visually-hidden\">Loading...</span></div></div>');
                    new bootstrap.Modal(document.getElementById('statusModal')).show();
                },
                success: function(response) {
                    $('#statusModal .modal-body').html(response);
                },
                error: function() {
                    $('#statusModal .modal-body').html('<div class=\"alert alert-danger\">So\'rovni tekshirishda xatolik yuz berdi.</div>');
                }
            });
        } else {
            alert('Iltimos, kuzatuv kodini kiriting.');
        }
    });
");
?>