                                ...
                                <?php if (!empty($post->tags)): ?>
                                    <div class="post-tags-container">
                                        <?php foreach ($post->tags as $tag): ?>
                                            <span class="post-tag">
                                                <a href="<?= \yii\helpers\Url::to(['posts/index', 'tag' => $tag->slug]) ?>"
                                                   class="post_category"
                                                   style="color: white;">
                        ...
                        <div class="ul_li xb-item--wrap">
                            <div class="xb-item--content">
                                <div class="post_meta_wrap">
                                    <div class="post_meta_flex flex items-center flex-wrap gap-2 text-sm text-gray-500">
                                        <?php if (!empty($post->tags)): ?>
                                            <div class="post-tags-container flex flex-wrap gap-1">
                                                <?php foreach ($post->tags as $tag): ?>
                                                    <span class="post-tag">
                                                        <a href="<?= \yii\helpers\Url::to(['posts/index', 'tag' => $tag->slug]) ?>"
                                                           class="post_category inline-block bg-gray-200 text-gray-700 text-xs font-semibold px-2 py-1 rounded-full hover:bg-gray-300 transition-colors">
                                        ...
                                        <?php if (!empty($post->view_count)): ?>
                                            <div class="post_view_count_wrap flex items-center">
                                                <span class="post_view_count flex items-center">
                                                    <i class="far fa-eye mr-1"></i> <?= Html::encode($post->view_count) ?>
                                                </span>
                                            </div>
                                        <?php endif; ?>
                                    </div>
